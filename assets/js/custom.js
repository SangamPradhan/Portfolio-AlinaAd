...
// Select the button and the menu_tooltip element
const button = document.querySelector('.portfolio_btn.btn_red');
const menuTooltip = document.querySelector('.menu_tooltip');

// Add a click event listener to the button
button.addEventListener('click', () => {
    // Trigger the same functionality as the menu_tooltip
    menuTooltip.click(); // Simulate a click on the menu_tooltip element
});